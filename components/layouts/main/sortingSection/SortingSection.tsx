...
import deleteSvgUrl from '@/public/images/delete.svg';
import penSvgUrl from '@/public/images/pen.svg';
import shareSvgUrl from '@/public/images/share.svg';
...
function SortingSection({ selectedFolder, setSelectedFolder }: SortingSectionProps) {
  ...
  const handleOptionListClick = {
    share: () => openModal(modalList.ShareModal, { folder: selectedFolder, onSubmit() {} }),
    editFolderName: () =>
      openModal(modalList.EditFolderNameModal, {
